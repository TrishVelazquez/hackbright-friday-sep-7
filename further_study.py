...
def custom_append(input_list, value):
    ...
    """
    my_len = custom_len(input_list)

    input_list[my_len:my_len+1] = [value]
...
def custom_insert(input_list, index, value):
    ...
    """
    first_part = input_list[0:index]
    last_part = input_list[index+1:]

    custom_append(first_part, value)
    custom_extend(first_part, last_part)
    input_list = first_part
    pass
